...
loader.add("images/BG_empty.png").add("images/FlagsSolo1.3.png").add("images/FlagsSolo2.3.png").add("images/Hotairbaloon2SOLO.png").add("images/HotairbaloonSOLO.png").add("images/BG_win.png").add("images/BG_lose.png").add("images/BG_start2.png")
...
//.add("images/knot.png")
.add("images/Note_1.png").add("images/Note_2.png").add("images/Note_3.png").add("images/Note_4.png").add("images/Note_5.png").add("images/Badnote_1.png").add("images/Badnote_2.png").add("images/Badnote_3.png")
...
//.add("images/cat.png")
.add("images/static_ham_wheel.png").add("images/dynamic_ham_wheel.png")
...
.add("images/curseur_Menu.png").add("images/BG_2ndloop.png").add("images/OuterMagicGates.png").add("images/Weapons/Weapon1 - Peanut1.3.png").add("images/Weapons/Weapon2 - Lazer3.3.png").add("images/portee vide3.png").add("images/Skills_bar3.png").add("images/Weapons/slingshot charged 1.png").add("images/Weapons/Weapon2.png").add("images/Weapons/Weapon3.png").add("images/Weapons/Weapon2 - Lazer 123 .png").add("images/Weapons/Weapon3 - Bullet1.png")
...
.add("sounds/" + sound_bank["Countdown_Start_Race"]).add("sounds/" + sound_bank["musique_game"]).add("sounds/" + sound_bank["tool_select"])
...
.add("sounds/" + sound_bank["ending"]).add("sounds/" + sound_bank["slingshot_charging"]).add("sounds/" + sound_bank["shot_no_weapon"]).add("sounds/" + sound_bank["gun_charging"]).add("sounds/" + sound_bank["short_slingshot_sound"]).add("sounds/" + sound_bank["shot_lazer_weapon_2"]).load(setup);
...
function setup() {
    ...
    skills_bar = new PIXI.TilingSprite(textureSkillbar, 1992 / 3, 340);
    ...
    bullet_lazer1 = new PIXI.TilingSprite(textureLazer, 100, 100);
    bullet_lazer1.x = 950;
    ...
    //Create the `bullet` sprite
    bullet2_lazer1 = new PIXI.TilingSprite(textureLazer, 100, 100);
    ...
    //Create the `bullet` sprite
    bullet3_lazer1 = new PIXI.TilingSprite(textureLazer, 100, 100);
    ...
    //Create the `bullet` sprite
    bullet4_lazer1 = new PIXI.TilingSprite(textureLazer, 100, 100);
    ...
    bullet_gun1 = new PIXI.TilingSprite(textureGun, 100, 100);
    bullet_gun1.x = 950;
    bullet_gun1.y = 1280;
    bullet_gun1.vx = 0;
    bullet_gun1.vy = 0;
    ...
    //Create the `bullet` sprite
    bullet2_gun1 = new PIXI.TilingSprite(textureGun, 100, 100);
    bullet2_gun1.x = 950;
    bullet2_gun1.y = 1280;
    bullet2_gun1.vx = 0;
    bullet2_gun1.vy = 0;
    ...
    //Create the `bullet` sprite
    bullet3_gun1 = new PIXI.TilingSprite(textureGun, 100, 100);
    bullet3_gun1.x = 950;
    bullet3_gun1.y = 1280;
    bullet3_gun1.vx = 0;
    bullet3_gun1.vy = 0;
    ...
    //Create the `bullet` sprite
    bullet4_gun1 = new PIXI.TilingSprite(textureGun, 100, 100);
    bullet4_gun1.x = 950;
    bullet4_gun1.y = 1280;
    bullet4_gun1.vx = 0;
    bullet4_gun1.vy = 0;
    ...
    hamster = new PIXI.TilingSprite(textureHamster, 500, 459);
...
function onLoseGame() {
    ...
    if (mode != 'lose') {
        ...
        msg_status.text = '             don\'t miss notes \n' + '       don\'t hit black notes \n';
        msg_status.y = 700;
        msg_status.x = 40;
...
function play(delta) {
    ...
    switch (mode) {
        case 'normal':
            ...
            if (hamster.progress >= 100 && hamster.vx > 0) {
                // touch right
